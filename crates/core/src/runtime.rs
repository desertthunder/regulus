...
const STDLIB_RUNTIME_PRIMITIVES: &[StdlibRuntimePrimitive] = &[
    ...
    primitive("gleam/dynamic/decode", "at"),
    primitive("gleam/dynamic/decode", "failure"),
    primitive("gleam/dynamic/decode", "field"),
    primitive("gleam/dynamic/decode", "float"),
    primitive("gleam/dynamic/decode", "int"),
    primitive("gleam/dynamic/decode", "list"),
    primitive("gleam/dynamic/decode", "map"),
    primitive("gleam/dynamic/decode", "one_of"),
    primitive("gleam/dynamic/decode", "optional"),
    primitive("gleam/dynamic/decode", "recursive"),
    primitive("gleam/dynamic/decode", "run"),
    primitive("gleam/dynamic/decode", "success"),
    primitive("gleam/dynamic/decode", "string"),
    primitive("gleam/dynamic/decode", "subfield"),
