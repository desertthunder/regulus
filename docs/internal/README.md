...
The public/user docs live in `docs/website`. The teaching book lives in
`docs/book`.

## Specs

- [Project compilation and dependencies](specs/14_project_compilation_and_dependencies.md)
...
- [Project compilation and dependencies](tasks/14_project_compilation_and_dependencies.md)
